...
use easlib::{get_result_status, build_static_locations, build_static_locations1};

use std::env;
// Result <bool, reqwest::Error >
async fn eas_process(path_to_archive: &str, address: &str, address1: i32,path_to_restore: &str, display: bool) ->  Result <bool, reqwest::Error > {
    println!("Step1");
...
async fn main() {
    ...
    let address1 = build_static_locations1(1,file_to_archive);
